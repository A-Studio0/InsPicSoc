...
package com.astudio.android.bitmapfun.util;
...
import com.astudio.inspicsoc.BuildConfig;
...
public class ImageFetcher extends ImageResizer {
	...
	private void checkConnection(Context context) {
		...
		if (networkInfo == null || !networkInfo.isConnectedOrConnecting()) {
			Toast.makeText(context, "世界上最遥远的距离就是没有网络", Toast.LENGTH_LONG)
					.show();
	...
	public static File downloadBitmap(Context context, String urlString) {
		...
		urlString = InsUrl.GET_IMAGE_REQ.replace("@path", urlString);
