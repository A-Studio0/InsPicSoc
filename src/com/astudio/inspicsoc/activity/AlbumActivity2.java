...
public class AlbumActivity2 extends InsActivity{
	...
	private void setListener() {
		...
		mDetermine.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mSelect.size() == 1) {
					// 跳转到图片编辑界面
					intent.setClass(AlbumActivity2.this,
					...
					intent.putExtra(
							...
							mList.get(Integer.parseInt(mSelect.get(0))).get(
									"image_path"));
					// 关闭手机图片列表的显示界面
					PhoneAlbumActivity2.mInstance.finish();
				}
				// 开始跳转界面
	...
	private class AlbumAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(AlbumActivity2.this).inflate(
				...
				int padding = (int) TypedValue.applyDimension(
						TypedValue.COMPLEX_UNIT_DIP, 40, AlbumActivity2.this
