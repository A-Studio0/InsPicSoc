...
public class PhoneAlbumActivity2 extends InsActivity{
	...
	private void setListener() {
		...
		mDisplay.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				intent.setClass(PhoneAlbumActivity2.this, AlbumActivity2.class);
	...
	private class PhoneAlnumAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(PhoneAlbumActivity2.this)
