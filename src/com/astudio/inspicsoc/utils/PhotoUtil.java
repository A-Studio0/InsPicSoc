...
public class PhotoUtil {
	...
	public static boolean saveToSDCard(Bitmap bitmap) {
		...
		File file = new File("/sdcard/InsPicSoc/Download/");
		if (!file.exists()) {
			file.mkdirs();
		}
		String fileName = UUID.randomUUID().toString() + ".jpg";
		String filePath = "/sdcard/InsPicSoc/Download/" + fileName;
	...
	public static String saveToLocal(Bitmap bm) {
		...
		FileOutputStream fileOutputStream = null;
		File file = new File("/sdcard/InsPicSoc/Images/");
		if (!file.exists()) {
			file.mkdirs();
		}
		String fileName = UUID.randomUUID().toString() + ".jpg";
		String filePath = "/sdcard/InsPicSoc/Images/" + fileName;
		File f = new File(filePath);
		if (!f.exists()) {
			try {
				f.createNewFile();
